...
export class PastebinComponent implements OnInit {
 ...
 // loadPastebin() is called on init
  ...
  public loadPastebin() {
    // * invokes pastebin service's getPastebin() method
    // * and stores the response in `pastebin` property
    this.pastebinServ.getPastebin().subscribe(pastebin => this.pastebin = pastebin);
  }
